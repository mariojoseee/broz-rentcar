...
<html lang="en">
  <head>
    <title>Broz Rent Car | Tentang Kami</title>
    <meta charset="utf-8" />
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="tentang_kami.php" class="nav-link">Tentang Kami</a></li>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
            <p class="breadcrumbs">
              ...
              ></span>
              <span>Tentang Kami <i class="ion-ios-arrow-forward"></i></span>
            </p>
        ...
        <div class="row">
          <div class="col-md-12 ftco-animate">
            <blockquote class="blockquote text-right">
              <h1 class="font-weight-bold mb-4">BROZ - RENT CAR</h1>
              <h4>
                Broz Rent Car merupakan situs website penyedia rental mobil terbaik, terlengkap, dan termurah sejagat raya. Kami memberikan layanan rental mobil untuk perusahaan maupun personal yang mengutamakan kenyamanan, keamanan, serta
                ketentraman pada pelanggan. Kendaraan yang kami sediakan merupakan kendaraan kualitas terbaik dan tak terkalahkan (PRO). Harga yang kami tawarkan juga merupakan harga termurah dengan kualitas termantap dari segala rent car
                yang ada di penjuru dunia ini. Kami menyediakan metode pembayaran yang beragam, agar pelanggan tidak kerepotan dalam melakukan transaksi. Jadi tunggu apa lagi segera pesan kendaraan terbaik anda hanya disini.
              </h4>
            </blockquote>
          </div>
        </div>
