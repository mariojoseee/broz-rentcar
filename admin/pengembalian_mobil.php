...
$data_sewa = query("SELECT datasewa.id_sewa, mobil.id_mobil, datasewa.no_ktp, datasewa.bukti_ktp, customer.nama_cst, customer.no_telp, mobil.nama_mobil, mobil.nopol, datasewa.tgl_sewa, datasewa.lama_sewa, (harga*lama_sewa) AS total_biaya, mobil.status FROM customer
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Data Pengembalian Mobil</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Laporan Konfirmasi Pengembalian Mobil</li>
            </ol>
            <div class="card-header">
              <i class="fas fa-table me-1"></i>
              Database Pengembalian Mobil
            </div>
            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <a href="ubah_pengembalian_mobil.php?id_mobil=<?=$row["id_mobil"];?>" onclick="return confirm('Yakin ingin mengubah status pengembalian mobil atas nama <?=$row['nama_cst'];?> dengan mobil <?=$row['nama_mobil'];?> ?');">
                    <button type="submit" name="status_mobil" class="text-white badge bg-<?=($row['status']) ? "success" : "danger"?>">
                    <?=($row['status']) ? "Sudah Mengembalikan" : "Belum Mengembalikan"?>
                    </button>
                  </a>
                  </td>
                </tr>
