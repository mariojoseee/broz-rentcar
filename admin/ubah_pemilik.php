...
// QUERY DATA PEMILIK BERDASARKAN ID
$pemilik = query("SELECT * FROM pemilikmobil WHERE id_pemilik = $id_pemilik")[0];

// CEK APAKAH TOMBOL UBAH DATA SUDAH DITEKAN ATAU BELUM
if (isset($_POST["update"])) {
    // CEK APAKAH DATA BERHASIL DIUBAH ATAU TIDAK
    if (f_ubahPemilik($_POST) >= 0) {
        echo "
			<script>
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-5">
            <h1 class="mt-4">Edit Data Pemilik Mobil</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="data_pemilik.php">Data Pemilik</a></li>
              <li class="breadcrumb-item active">Form Edit Pemilik Mobil</li>
            </ol>
            ...
            <form action="" method="post" class="row g-4" style="max-width: 2000px;">
              ...
              <div class=" mb-1 input-group-lg">
                ...
                <input type="text" name="no_stnk" class="form-control" id="no_stnk" placeholder="Masukan nomor stnk mobil" value="<?=$pemilik["no_stnk"];?>" required />
              </div>
              <div class=" mb-1 input-group-lg">
                <label for="nama_pemilik" class="form-label fs-5">Nama Lengkap</label>
                <input type="text" name="nama_pemilik" class="form-control" id="nama_pemilik" placeholder="Masukan nama lengkap" value="<?=$pemilik["nama_pemilik"];?>" required />
              </div>
              <div class="input-group-lg">
                <label for="no_telp" class="form-label fs-5">Nomor Telephone</label>
                <input type="text" name="no_telp" class="form-control" id="no_telp" placeholder="Masukan nomor telephone" value="<?=$pemilik["no_telp"];?>" required />
              </div>
              <div class="mb-3 input-group-lg">
                <label for="alamat" class="form-label fs-5">Alamat Lengkap</label>
                <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Masukan alamat lengkap" value="<?=$pemilik["alamat"];?>" required />
              </div>
