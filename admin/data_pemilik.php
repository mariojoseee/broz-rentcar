...
$data_pemilik = query("SELECT * FROM pemilikmobil");

//TOMBOL CARI DITEKAN
if (isset($_POST["cari"])) {
    $data_pemilik = cari_pemilik($_POST["keyword"]);
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Data Pemilik Mobil</h1>
            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody>
                <?php $i = 1;?>
                <?php foreach ($data_pemilik as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="ubah_pemilik.php?id_pemilik=<?=$row["id_pemilik"];?>"><span class="badge bg-warning text-dark">EDIT</span></a> |
                    <a href="hapus_pemilik.php?id_pemilik=<?=$row["id_pemilik"];?>" onclick="return confirm('Yakin ingin menghapus data tersebut?');"><span class="badge bg-danger">HAPUS</span></a>
                  </td>
                </tr>
                <?php $i++;?>
                <?php endforeach;?>
