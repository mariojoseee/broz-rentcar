...
$data_sewa = query("SELECT datasewa.id_sewa, datasewa.no_ktp, datasewa.bukti_ktp, customer.nama_cst, customer.no_telp, mobil.nama_mobil, datasewa.tgl_sewa, datasewa.lama_sewa, (harga*lama_sewa) AS total_biaya, datasewa.status FROM customer
...
<html lang="en">
  <head>
    ...
    <title>Broz Rent Car | Transaksi Customer</title>
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Data Transaksi Customer</h1>
            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td><?=$i;?></td>
                  <td><?=$row["no_ktp"];?></td>
                  <td><img src="../img/<?=$row["bukti_ktp"];?>" width="100"></td>
                  <td><?=$row["nama_cst"];?></td>
                  <td><?=$row["no_telp"];?></td>
                  ...
                  <td class="text-center">
                    <a href="hapus_transaksi.php?id_sewa=<?=$row["id_sewa"];?>" onclick="return confirm('Yakin ingin menghapus data tersebut?');"><span class="badge bg-danger">HAPUS</span></a>
                  </td>
                </tr>
                <?php $i++;?>
                <?php endforeach;?>
